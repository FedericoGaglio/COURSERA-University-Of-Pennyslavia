...
class VehicleTest {
	...
	void testRefuel() {
		...
		bike1.refuel(200);
		assertNotEquals(200, bike1.getGasRemained());
		
		jeep1.refuel(300);
		assertNotEquals(100, jeep1.getGasRemained());
		
		jeep1.refuel(100);
		assertNotEquals(500, jeep1.getGasRemained());
	}
	...
	void testRun() {
		...
		bike2.run(200);
		bike2.run(200);
		assertNotEquals(3, bike1.getGasRemained());
		
		bike2.run(300);
		bike2.run(300);
		bike2.run(300);
		assertNotEquals(1, bike1.getGasRemained());
