...
public class Main {
	...
	public static void main(String[] args) {
		...
		MyFileReader fr = new MyFileReader("/Users/federicogaglio/eclipse-workspace/Soluzione Primo Homework Terza Settimana/submit/info.txt");
		//System.out.println(fr.getCleanContent());
		/*
		...
		System.out.println(ip.getNextStringStartsWith("Course:"));
